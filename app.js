...
document.getElementById("alif1").innerHTML=Counter1*4913;

document.getElementById("laa").innerHTML=Counter2;
document.getElementById("laa2").innerHTML=Counter2*9826;

document.getElementById("haa").innerHTML=Counter3;
document.getElementById("haa3").innerHTML=Counter3*14739;

document.getElementById("mim").innerHTML=Counter4;
document.getElementById("mim4").innerHTML=Counter4*19652;

document.getElementById("dal").innerHTML=Counter5;
document.getElementById("dal5").innerHTML=Counter5*24565;

document.getElementById("haae").innerHTML=Counter6;
document.getElementById("haae6").innerHTML=Counter6*29478;

document.getElementById("raa").innerHTML=Counter7;
document.getElementById("raa7").innerHTML=Counter7*34391;

document.getElementById("baa").innerHTML=Counter8;
document.getElementById("baa8").innerHTML=Counter8*39304;

document.getElementById("ine").innerHTML=Counter9;
document.getElementById("ine9").innerHTML=Counter9*44217;

document.getElementById("yaa").innerHTML=Counter10;
document.getElementById("yaa10").innerHTML=Counter10*49130;

document.getElementById("noon").innerHTML=Counter11;
document.getElementById("noon11").innerHTML=Counter11*54043;

document.getElementById("kaf").innerHTML=Counter12;
document.getElementById("kaf12").innerHTML=Counter12*58956;


document.getElementById("ouaou").innerHTML=Counter13;
document.getElementById("ouaou13").innerHTML=Counter13*63869;


document.getElementById("sin").innerHTML=Counter14;
document.getElementById("sin14").innerHTML=Counter14*68782;

document.getElementById("taa").innerHTML=Counter15;
document.getElementById("taa15").innerHTML=Counter15*73695;

document.getElementById("saad").innerHTML=Counter16;
document.getElementById("saad16").innerHTML=Counter16*78608;

document.getElementById("ttae").innerHTML=Counter17;
document.getElementById("ttae17").innerHTML=Counter17*83521;

document.getElementById("ppaf").innerHTML=Counter18;
document.getElementById("ppaf18").innerHTML=Counter18*88434;


document.getElementById("ddal").innerHTML=Counter19;
document.getElementById("ddal19").innerHTML=Counter19*93347;

document.getElementById("gaa").innerHTML=Counter20;
document.getElementById("gaa20").innerHTML=Counter20*98260;

document.getElementById("daa").innerHTML=Counter21;
document.getElementById("daa21").innerHTML=Counter21*103173;

document.getElementById("faa").innerHTML=Counter22;
document.getElementById("faa22").innerHTML=Counter22*108086;

document.getElementById("zay").innerHTML=Counter23;
document.getElementById("zay23").innerHTML=Counter23*112999;

document.getElementById("kha").innerHTML=Counter24;
document.getElementById("kha24").innerHTML=Counter24*117912;

document.getElementById("chine").innerHTML=Counter25;
document.getElementById("chine25").innerHTML=Counter25*122825;

document.getElementById("ddda").innerHTML=Counter26;
document.getElementById("ddda26").innerHTML=Counter26*127738;

document.getElementById("jim").innerHTML=Counter27;
document.getElementById("jim27").innerHTML=Counter27*132651;

document.getElementById("ttta").innerHTML=Counter28;
document.getElementById("ttta28").innerHTML=Counter28*137564;
...
document.getElementById("best3").innerHTML= Counter1*4913 + Counter2*9826 + Counter3*14739 + Counter4*19652 + Counter5*24565 + Counter6*29478 + Counter7*34391 + Counter8*39304 + Counter9*44217 + Counter10*49130 + Counter11*54043 + Counter12*58956 + Counter13*63869 + Counter14*68782 + Counter15*73695 + Counter16*78608 + Counter17*83521 + Counter18*88434 + Counter19*93347 + Counter20*98260 + Counter21*103173 + Counter22*108086 + Counter23*112999 + Counter24*117912 + Counter25*122825 + Counter26*127738 + Counter27*132651 + Counter28*137564  ;
...
var
  ...
  document.getElementById("core").innerHTML= (roma * 8000)+2 ;      
  ...
  document.getElementById("kon1").innerHTML= (kaoune * 31417)+2 ;      
